...
import AddReferenceForm from "../user-forms/AddReferenceForm";

const AddReferenceModal = ({isOpen, onClose}) => {
...
if (!isOpen) return null;
  ...
  return (
    ...
    <div className="relative top-20 mx-auto p-3 border w-96 md:w-2/3 lg:w-1/2 shadow-lg rounded-md bg-white dark:bg-gray-800 dark:text-gray-200">
      <h2 className="text-lg font-bold mb-4 ml-5">Add New Reference</h2>
      <AddReferenceForm />

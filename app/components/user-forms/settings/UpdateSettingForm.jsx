...
const handleToggleEducationSection = () => {
  ...
  const handleSaveSettings = async () => {
    ...
    try {
        ...
        if (res.ok) {
            toast.success('New Settgins Added succesfully', {
                position: "top-right",
                autoClose: 3000,
  ...
  return (
    <div className="max-w-md mx-auto mt-8 p-4">
      ...
      <button onClick={handleSaveSettings} className="w-full bg-blue-500 text-white py-2 rounded-md shadow-md hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50">
        Save Settings
      </button>
    </div>
  );

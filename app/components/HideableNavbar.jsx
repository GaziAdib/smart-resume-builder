...
const HideableNavbar = ({ hiddenRoutes }) => {
  ...
  const isNavbarHidden = hiddenRoutes?.includes(pathname);

  if (isNavbarHidden) {
    return null; // If the navbar should be hidden, return null
  }

  // If the navbar should be shown, return the navbar component
  return (
